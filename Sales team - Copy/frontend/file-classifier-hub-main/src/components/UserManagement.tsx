...
export function UserManagement() {
  ...
  const AVAILABLE_MODULES = [
    ...
    { id: "SBC", label: "SBC plan summary" },
    { id: "RENEWAL", label: "Census Creation" },
    { id: "RE", label: "Resourcing Edge" },
    { id: "RPVE", label: "Invoice to Census" },
    ...
    { id: "WORK_COMP", label: "Accord 130" },
    { id: "LOSS_RUN", label: "Loss Run" },
    { id: "INVOICE", label: "Benefit Invoice Extraction" },
    { id: "PAYROLL", label: "Payroll Register Extraction" },
    { id: "PSH_CLAIM_VALIDATOR", label: "UI Claim Validator" },
    { id: "PSH_CLAIM_EXTRACTOR", label: "UI Claim Extractor" },
    { id: "BANK_STATEMENT", label: "Bank Statement" },
    { id: "VENDOR_INVOICE", label: "Vendor Invoice" },
    { id: "ASTRYA_INVOICE", label: "Invoice to Excel" },
