  ...
  return (
    <div className="flex flex-col gap-3 p-4 rounded-xl border border-dashed border-border bg-muted/20">
      <div className="flex flex-col gap-2">
        ...
        <div className="flex gap-2">
          <Button
            ...
            className="bg-emerald-600 hover:bg-emerald-700 text-white flex-1 h-9 text-xs disabled:opacity-50 disabled:bg-muted"
          >
            <Merge className="w-4 h-4 mr-2" />
            {isMergeable ? finalMergeLabel : "Merge"}
          </Button>
          <Button
            variant="outline"
            onClick={onDownloadCsv}
            disabled={!isMergeable}
            className="border-emerald-600 text-emerald-600 hover:bg-emerald-50 flex-1 h-9 text-xs disabled:opacity-30"
          >
      ...
      <Button
        ...
        className="w-full bg-primary hover:bg-primary/90 text-primary-foreground h-10 shadow-sm text-xs disabled:opacity-50"
      >
        {isAnalyzing ? (
